...
provider "registry.terraform.io/azure/azapi" {
  version     = "2.8.0"
  constraints = "~> 2.0, ~> 2.4, ~> 2.5, >= 2.7.0, ~> 2.7, < 3.0.0"
  hashes = [
...
provider "registry.terraform.io/azure/modtm" {
  version     = "0.3.5"
  constraints = ">= 0.3.0, ~> 0.3.0, ~> 0.3, < 1.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/azurerm" {
  version     = "4.58.0"
  constraints = ">= 3.66.0, >= 3.71.0, >= 3.116.0, >= 3.117.0, >= 4.0.0, ~> 4.0, >= 4.8.0, ~> 4.12, ~> 4.14, >= 4.19.0, >= 4.21.1, >= 4.36.0, >= 4.37.0, >= 4.46.0, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/random" {
  version     = "3.7.1"
  constraints = ">= 3.3.2, >= 3.5.0, ~> 3.5, >= 3.5.1, ~> 3.6, >= 3.6.2, 3.7.1, < 4.0.0, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/time" {
  version     = "0.13.1"
  constraints = ">= 0.9.0, ~> 0.9, ~> 0.13, < 1.0.0"
  hashes = [
